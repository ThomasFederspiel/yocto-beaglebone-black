...
LINUX_VERSION ?= "4.14"
LINUX_SUBLEVEL ?= ".79"
LINUX_VERSION_EXTENSION ?= "-custom-ti-rt"
...
#
FILES_${PN} += "/lib/modules/${LINUX_VERSION}${LINUX_SUBLEVEL}+git${SRCPV}-custom-ti-rt/kernel/*"
...
SRCREV_beaglebone = "1e77f294451ac7391b677805bde6bc42166e7c21"

PR = "r1"
PV = "${LINUX_VERSION}${LINUX_SUBLEVEL}+git${SRCPV}"
