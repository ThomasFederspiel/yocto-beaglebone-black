...
SRC_URI = "git://github.com/beagleboard/linux.git;protocol=https;nocheckout=1;branch=4.14;name=beaglebone \
           file://defconfig \
...
#
FILES_${PN} += "/lib/modules/${LINUX_VERSION}${LINUX_SUBLEVEL}-custom/kernel/*"
...
SRCREV_beaglebone="b767d52519624aaa6426494ce9aaa39a5c7feaca"
